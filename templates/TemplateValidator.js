...
class TemplateValidator {
   ...
   * @since 2.0.0
   */
  validateBasicStructure(template, context) {
   ...
   * @since 2.0.0
   */
  validateLength(template, context) {
    const results = { errors: [], warnings: [], suggestions: [] };
   ...
   * @since 2.0.0
   */
  validateSyntax(template, context) {
    const results = { errors: [], warnings: [], suggestions: [] };
   ...
   * @since 2.0.0
   */
  validateBestPractices(template, context) {
    const results = { errors: [], warnings: [], suggestions: [] };
   ...
   * @since 2.0.0
   */
  validateSecurity(template, context) {
    const results = { errors: [], warnings: [], suggestions: [] };
   ...
   * @since 2.0.0
   */
  validatePerformance(template, context) {
    const results = { errors: [], warnings: [], suggestions: [] };
